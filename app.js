...
console.log("Mostrando a quantidade de index que a palavra tem:" +''+programmingLanguage.length)
...
console.log("Pegando apenas a ultima letra:" +''+ randomWord[randomWord.length -1]);
...
console.log('deixando tudo com letra minúscula:', summerMessage.toLowerCase());
...
console.log('Deixando tudo maiusculo:' +''+ winterMessage.toUpperCase())
/*
...
const realBestMovie = 'E o Oscar de melhor filme vai para: "Carros 2"!'
